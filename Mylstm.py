...
class MyLSTM(object):
    ...
    def __init__(self,sequence_length,embedding_size,hidden_units,class_num,l2_reg_lambda,batch_size):
        ...
        #create a convolution + maxpool_layer for each filter size
